package com.example.batalfirebasefinalsproject.Adapters;
...
import com.example.batalfirebasefinalsproject.EditProduct;
...
import com.example.batalfirebasefinalsproject.R;
...
public class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductAdapter.ViewHolder holder, int position) {
        ...
        holder.productQuantity.setText(product.getProduct_quantity());
        if(product.getProduct_price().length() > 15) {
            holder.productItemName.setTextSize(10);
            holder.productItemPrice.setText(product.getProduct_price());
        }
        else {
            holder.productItemPrice.setText(product.getProduct_price());
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        TextView productItemName,productItemPrice, productQuantity;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            //TextViews
            productItemName = itemView.findViewById(R.id.txtViewProductName);
            productItemPrice = itemView.findViewById(R.id.txtViewProductPrice);
            productQuantity = itemView.findViewById(R.id.txtViewProductQuantity);

            //ImageView
            productImage = itemView.findViewById(R.id.imageViewProductImage);
            //Buttons
            editButton = itemView.findViewById(R.id.btnEditProduct);
            deleteButton = itemView.findViewById(R.id.btnDeleteProduct);
        }
