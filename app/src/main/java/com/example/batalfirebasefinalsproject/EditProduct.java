...
import com.example.batalfirebasefinalsproject.Models.ProductImage;
...
public class EditProduct extends AppCompatActivity {
    ...
    private TextInputEditText product_name, product_price, product_description, textInputEditText_PProductID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(EditProduct.this, Home.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_NO_ANIMATION));
            }
        });
        ...
        add_product_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!String.valueOf(product_name.getText()).equals("") && !String.valueOf(product_price.getText()).equals("") && !String.valueOf(product_description.getText()).equals("") && !String.valueOf(quantity.getText()).equals("0")) {
                    ...
                    AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(EditProduct.this);
                    ...
                    builder.setItems(options, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Yes")) {
                                ...
                                productHashMap.put("product_name", String.valueOf(product_name.getText()));
                                productHashMap.put("product_quantity", String.valueOf(quantity.getText()));
                                productHashMap.put("product_price", String.valueOf(product_price.getText()));
                                productHashMap.put("product_description", String.valueOf(product_description.getText()));
                    ...
                    Toast.makeText(EditProduct.this, "Please complete all fields!", Toast.LENGTH_SHORT).show();
                }
            }
        });
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        ...
                        if (options[item].equals("Take Photo")) {
                            ...
                            if(takePicture.resolveActivity(getPackageManager()) != null) {
                                if (ContextCompat.checkSelfPermission(EditProduct.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                                    imageResultLauncher.launch(takePicture);
                                } else {
                                    Toast.makeText(EditProduct.this, "Please enable camera permissions", Toast.LENGTH_SHORT).show();
                                }
                            }
                            else {
                                Toast.makeText(EditProduct.this,"There's no app that supports this action", Toast.LENGTH_SHORT).show();
                            }
        ...
        remove_product_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                product_image.setImageResource(R.drawable.valorant_icon);
                Bitmap myBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.valorant_icon);
        ...
        FirebaseDatabase.getInstance().getReference("Products").child(selectedID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    //Text Views
                    quantity.setText(product.getProduct_quantity());

                    //Image Loader
                    if (product.getProduct_image().equals("")) {
                        Glide.with(getApplicationContext()).load(ProductImage.productImageDefault).diskCacheStrategy(DiskCacheStrategy.DATA).skipMemoryCache(false).into(product_image);
                    } else {
                        Glide.with(getApplicationContext()).load(product.getProduct_image()).diskCacheStrategy(DiskCacheStrategy.DATA).skipMemoryCache(false).into(product_image);
                    }
                }
            }
            @Override
    ...
    private void requestCameraPermission() {
        if (ContextCompat.checkSelfPermission(EditProduct.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(EditProduct.this, new String[]{Manifest.permission.CAMERA}, 5);
        } else {
    ...
    private void requestStoragePermission() {
        if (ContextCompat.checkSelfPermission(EditProduct.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(EditProduct.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 5);
        } else {
